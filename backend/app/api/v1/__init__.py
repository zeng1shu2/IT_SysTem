...
from app.api.v1 import asset, asset_modules, audit, auth, form_config, icons, permission, role, system_field, user
...
api_router.include_router(icons.router, prefix="/icons", tags=["图标库"])
